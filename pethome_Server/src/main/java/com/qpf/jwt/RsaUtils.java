...
public class RsaUtils {
    ...
    public static PrivateKey getPrivateKey(byte[] bytes) {
        try {
            ...
            throw new RuntimeException("字节转换私钥对象失败！");
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        generateKey("E:\\8.yuanma\\Idea_projects\\Pethome_Proj_MybatisPlus\\pethome_Server\\src\\main\\resources\\auth_rsa.pub", "E:\\8.yuanma\\Idea_projects\\Pethome_Proj_MybatisPlus\\pethome_Server\\src\\main\\resources\\auth_rsa.pri", "myRSA", 2048);
    }
}